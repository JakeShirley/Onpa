...
| FND-008 | done | Localization foundation | Localizable.xcstrings String Catalog with English (development), Spanish, German, and Japanese translations for static UI copy across Dashboard, Feed, Species, Detection detail, Station management, Settings, and Changelog. knownRegions and AGENTS.md policy updated; dynamic format strings (errors, percentages, accessibility labels) tracked as a follow-up. |
